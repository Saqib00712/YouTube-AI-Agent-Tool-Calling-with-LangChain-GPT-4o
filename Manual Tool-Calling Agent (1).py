...
get_ipython().run_line_magic('pip', 'install langchain-community==0.3.21 | tail -n 1')

get_ipython().run_line_magic('pip', 'install openai==1.68.2 | tail -n 1')
get_ipython().run_line_magic('pip', 'install pytube | tail -n 1')
get_ipython().run_line_magic('pip', 'install youtube-transcript-api | tail -n 1')
get_ipython().run_line_magic('pip', 'install yt-dlp | tail -n 1')
